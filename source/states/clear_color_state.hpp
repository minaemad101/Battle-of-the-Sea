...
class ClearColorState: public our::State {
    ...
    void onInitialize() override {
        ...
        float r = getApp()->getConfig().at("scene").at("clear-color").at("r");
        float g = getApp()->getConfig().at("scene").at("clear-color").at("g");
        float b = getApp()->getConfig().at("scene").at("clear-color").at("b");
        float a = getApp()->getConfig().at("scene").at("clear-color").at("a");
